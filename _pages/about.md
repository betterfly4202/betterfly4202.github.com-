...
그러던 중 1년차가 지나는 시점에 기술부채에 대한 갈증과 하나의 포지션에 집중하여 조금 더 좋은 퍼포먼스를 낼 수 있는 개발자가 되고 싶다는 고민과 함께 이직을 준비했습니다.

그리고 지난 10월에 스타트업으로 이직하여 Back-end 개발자로 새로운 개발 인생을 걸을 수 있게 되었습니다. 

이 곳에서는 GCP(Google Cloud Platform) 환경 아래에서 주로 <code>ETL업무<code>와 웹/앱에 전달되는 <code>Push 서비스</code>의 백엔드 개발자로서의 역할을 수행하게 되었습니다.
